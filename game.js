...
const setScoreforComputer = (newScore) => {
  COMSCORE =newScore;
  document.querySelector(".computerscore h2").innerText = newScore;
  localStorage.setItem("COMSCORE",1 + eval(localStorage.getItem("COMSCORE")));
  document.querySelector(".computerscore h2").innerText = localStorage.getItem("COMSCORE");
}

const setScore = (newScore) => {
  SCORE = newScore;
  document.querySelector(".userscore h2").innerText = newScore;
  localStorage.setItem("SCORE",1 + eval(localStorage.getItem("SCORE")));
  document.querySelector(".userscore h2").innerText = localStorage.getItem("SCORE");
}
